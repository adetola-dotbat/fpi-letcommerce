...
<!-- Mirrored from themesflat.com/html/modaz/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 27 Aug 2022 14:12:16 GMT -->

@include('customer.pages.header-script')
...
<body class="header_sticky header-style-1 has-menu-extra">
    ...
    <div class="boxed">
            ...
            <div id="rev-slider1" class="rev_slider fullwidthabanner">
                <ul>
                    ...
                    <li data-transition="random">
                        ...
                        <img src="customer/images/slider/slider-bg-5.jpg" alt="" data-bgposition="center center"
                            data-no-retina>
                        ...
                        <div class="tp-caption" data-x="['left','left','left','center']"
                            ...
                            data-splitin="none" data-splitout="none" data-responsive_offset="on">
                            <a href="customer/#"
                                class="themesflat-button has-padding-36 bg-accent has-shadow"><span>SHOP
                                    NOW</span></a>
                        </div>
                    </li>
                    ...
                    <li data-transition="random">
                        ...
                        <img src="customer/images/slider/slider-bg-1.jpg" alt="" data-bgposition="center center"
                            data-no-retina>
                        ...
                        <div class="tp-caption text-right" data-x="['right','right','right','center']"
                            ...
                            data-mask_in="x:0px;y:[100%];" data-mask_out="x:inherit;y:inherit;" data-start="1000"
                            data-splitin="none" data-splitout="none" data-responsive_offset="on">
                            <a href="customer/#" class="themesflat-button bg-accent has-shadow"><span>BY
                                    NOW</span></a>
                        </div>
                    </li>
        ...
        @include('customer.pages.banner')

        @include('customer.pages.new-product')

        @include('customer.pages.best-sale')

        @include('customer.pages.new-collection')

        @include('customer.pages.brands')

        @include('customer.pages.new-latest')

        @include('customer.pages.subscribe')
        ...
        <div class="footer-bottom">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <p class="copyright text-center">Copyright @2018 <a href="customer/#">Modaz</a></p>
                    </div>
                </div>
            </div>
        </div>
    ...
    @include('customer.pages.footer-script')
</body>

<!-- Mirrored from themesflat.com/html/modaz/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 27 Aug 2022 14:13:45 GMT -->
