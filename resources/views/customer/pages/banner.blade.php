            ...
            <div class="col-sm-6 col-md-4">
                <div class="flat-image-box style-1 data-effect div-h22 clearfix">
                    <div class="item data-effect-item">
                        <div class="inner">
                            <div class="thumb">
                                <img src="customer/images/image-box/imgbox-1-375x500.jpg" alt="Image">
                                <div class="elm-btn">
            ...
            <div class="col-sm-6 col-md-4">
                <div class="flat-image-box style-1 row2 data-effect clearfix">
                    <div class="item data-effect-item">
                        <div class="inner">
                            <div class="thumb">
                                <img src="customer/images/image-box/imgbox-1-375x240.jpg" alt="Image">
                                <div class="elm-btn">
                    ...
                    <div class="item data-effect-item">
                        <div class="inner">
                            <div class="thumb">
                                <img src="customer/images/image-box/imgbox-2-375x240.jpg" alt="Image">
                                <div class="elm-btn">
                                </div>
                                <div class="overlay-effect bg-color-1"></div>
                            </div>
            ...
            <div class="col-sm-6 col-md-4">
                <div class="flat-image-box style-1 data-effect div-h20 clearfix">
                    <div class="item data-effect-item">
                        <div class="inner">
                            <div class="thumb">
                                <img src="customer/images/image-box/imgbox-2-375x500.jpg" alt="Image">
                                <div class="elm-btn">
