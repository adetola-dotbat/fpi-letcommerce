            ...
            <div class="col-md-3">
                <div class="flat-icon-box icon-top style-1 clearfix text-center">
                    <div class="inner no-margin">
                        ...
                        <div class="text-wrap">
                            <h5 class="heading"><a href="customer/#">Free Shipping</a></h5>
            ...
            <div class="col-md-3">
                <div class="flat-icon-box icon-top style-1 clearfix text-center">
                    <div class="inner">
                        ...
                        <div class="text-wrap">
                            <h5 class="heading"><a href="customer/#">Cash On Delivery</a></h5>
            ...
            <div class="col-md-3">
                <div class="flat-icon-box icon-top style-1 clearfix text-center">
                    <div class="inner">
                        ...
                        <div class="text-wrap">
                            <h5 class="heading"><a href="customer/#">Gift For All</a></h5>
            ...
            <div class="col-md-3">
                <div class="flat-icon-box icon-top style-1 clearfix text-center">
                    <div class="inner">
                        ...
                        <div class="text-wrap">
                            <h5 class="heading"><a href="customer/#">Opening All Week</a></h5>
